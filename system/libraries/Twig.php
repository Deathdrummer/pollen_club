...
require_once BASEPATH . '/libraries/Twig/autoload.php';
class CI_Twig {
	/**
...
//		'set_radio', 'set_select', 'set_checkbox',
	...
	public function __construct($params = [])
	{
		...
		// default Twig config
		$this->config = [
			'cache'      => substr($_SERVER['SERVER_NAME'], -3) == 'loc' ? false : BASEPATH . 'cache/twig',
	...
	public function addFilter($name, $function) {
		$this->createTwig();
		$filter = new Twig_Filter($name, $function);
	...
	public function render($view, $params = [])
	{
		...
		return $this->twig->render($view, array_merge($params, ['components' => $this->componentsPath]));
	}
