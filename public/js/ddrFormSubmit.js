...
$.fn.ddrFormSubmit = async function(params = {}) {
	...
	_.assign(formData, buildFormData(formItems), buildAddictData(params));
...
$.fn.ddrForm = function(params = {}) {
	...
	_.assign(formData, buildFormData(formItems), buildAddictData(params)); // params -> fields files
	return formData;
};
...
function buildAddictData(params = {}) {
	...
	if (fields || _.values(params).length) {
